...
Open `app.py`.
```bash
Update the path to the checkpoint file, which is around line 259, line 266, line 273.  
Update the path to the global_data.json, which is around line 267, line 275.
```
