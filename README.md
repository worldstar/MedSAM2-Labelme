...
### Auto set label name
By providing a label name in the input field, the system automatically assigns corresponding labels to the masks generated by the model (e.g., label name_1).  
<div align="center">
  <img src="https://github.com/worldstar/MedSAM2-Labelme/blob/main/examples/medsam2/modeselect.png" width=70%/>
</div>
