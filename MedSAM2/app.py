...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def choose_medsam2(self):
        ...
        icon_path = "D:/anaconda3/envs/labelme/Lib/site-packages/labelme/icons/"
        modes = {
            "ENTIRE FOLDER (AUTO)": ("auto_folder", icon_path+"med-ai.PNG"),
            "ONE IMAGE (AUTO)": ("auto_one", icon_path+"med-ai1.PNG"),
            "BATCH TASK (CLICK)": ("semi_n", icon_path+"med-ai2.PNG"),
            "SEMI-AUTO (CLICK)": ("semi_auto", icon_path+"med-ai3.PNG"),
        }
    ...
    def on_button_click(self, mode):
        path_ = "D:/anaconda3/envs/labelme/Lib/site-packages/labelme/checkpoints/checkpoint-all-4.pt"
        checkpoint_paths = {
            "auto_folder": path_,
            "auto_one": path_,
            "semi_n": path_,
