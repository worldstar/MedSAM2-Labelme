...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(
        ...
        medsam2_all = action(
            self.tr("&Semi\n(Click)"),
            lambda: self.medsam2(checkpoint_path=os.path.dirname(os.path.abspath(__file__))+"/checkpoints/checkpoint-all.pt",
                                 globa_data_path=os.path.dirname(os.path.abspath(__file__))+"/checkpoints/global_data.json"),
            shortcuts["semi_med"],
            "med-ai",
    ...
    def choose_medsam2(self):
        ...
        modes = {
            "ENTIRE FOLDER (AUTO)": ("auto_folder", icon_path+"/icons/med-ai.PNG"),
            "ONE IMAGE (AUTO)": ("auto_one", icon_path+"/icons/med-ai1.PNG"),
            "BATCH TASK (CLICK)": ("semi_n", icon_path+"/icons/med-ai2.PNG"),
            "SEMI-AUTO (CLICK)": ("semi_auto", icon_path+"/icons/med-ai3.PNG"),
        }
    ...
    def on_button_click(self, mode):
        ...
        if mode == "auto_folder":
            ...
            self.medsam2(checkpoint_path=checkpoint_path, globa_data_path=os.path.dirname(os.path.abspath(__file__))+"/global_data.json")
